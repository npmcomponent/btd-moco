...
try {
    ...
    // commented out by npm-component: var Emitter = require('emitter-component');
}
...
var createModel = function(modelOptions) {
    var Model = function(attributes) {
        ...
        util.forOwn(this.constructor.attributes, function(attributeOptions, name) {
    ...
    Model.attr = function(name, attributeOptions) {
        if(!this.attributes[name]) { //we do not have this attribute
            ...
            util.defaultValue(attributeOptions, 'get', false);
            util.defaultValue(attributeOptions, 'default', undefined);
            util.defaultValue(attributeOptions, 'primary', false);
